...
<template>
  ...
  >
    <div class="aspect-w-16 aspect-h-9 bg-gray-100">
      ...
      <div
        v-else
        class="w-full h-48 bg-gradient-to-br from-sage-100 to-sage-200 flex items-center justify-center"
      >
    ...
    <div class="p-6">
      ...
      <div class="space-y-2 mb-4">
        <div
          v-if="entry.cuisine"
          class="inline-block bg-sage-100 text-sage-800 text-xs px-2 py-1 rounded-full"
        >
          {{ entry.cuisine }}
        </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div
            v-if="entry.price"
            class="text-sm font-medium text-terracotta-700"
          >
            {{ entry.price }}
          </div>
        </div>
